...
ActiveRecord::Schema.define(version: 20_170_505_063_918) do
  ...
  create_table 'article_comments', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.integer  'user_id',                  null: false
    t.text     'text', limit: 65_535, null: false
    t.datetime 'created_at',               null: false
    t.datetime 'updated_at',               null: false
    t.index %w[article_id user_id], name: 'index_article_comments_on_article_id_and_user_id', using: :btree
  ...
  create_table 'chat_messages', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.datetime 'created_at',                 null: false
    t.datetime 'updated_at',                 null: false
    t.index %w[chat_room_id user_id], name: 'index_chat_messages_on_chat_room_id_and_user_id', using: :btree
  ...
  create_table 'intermediate_table_article_favorites', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[user_id article_id], name: 'article_favorites_unique', unique: true, using: :btree
  ...
  create_table 'intermediate_table_article_tag_relations', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.index %w[tag_id article_id], name: 'article_tag_relations_unique', unique: true, using: :btree
  ...
  create_table 'intermediate_table_chat_room_user_relations', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.datetime 'updated_at',   null: false
    t.index ['chat_room_id'], name: 'chat_room_id', using: :btree
    t.index %w[user_id chat_room_id], name: 'chat_room_user_unique', unique: true, using: :btree
    t.index ['user_id'], name: 'user_id', using: :btree
  end
  ...
  create_table 'intermediate_table_user_relationships', force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    ...
    t.datetime 'created_at',   null: false
    t.datetime 'updated_at',   null: false
    t.index %w[follower_id following_id], name: 'user_relationships_unique', unique: true, using: :btree
